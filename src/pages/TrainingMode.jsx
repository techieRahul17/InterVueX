...
const TrainingMode = () => {
    ...
    if (isRecording) {
      ...
      timerRef.current = setInterval(() => {
        ...
        setSentimentScore((prev) => ({
          confidence: Math.min(
            100,
            Math.max(0, prev.confidence + (Math.random() * 10 - 5))
          ),
          clarity: Math.min(
            100,
            Math.max(0, prev.clarity + (Math.random() * 10 - 5))
          ),
          engagement: Math.min(
            100,
            Math.max(0, prev.engagement + (Math.random() * 10 - 5))
          ),
        }))
      }, 1000)
    } else {
  ...
  const generateQuestions = () => {
    ...
    const skillQuestions =
      questionsBySkill[selectedSkill] || questionsBySkill['React']
      ...
      setTranscript([
        {
          ...
          text: "Hello! I'll be your interviewer today. Let's start with the first question.",
        },
  ...
  const generateFeedback = () => {
    ...
    setSessionStats((prev) => ({
      ...
      averageScore:
        (prev.averageScore * prev.questionsAnswered + feedbackData.score) /
        (prev.questionsAnswered + 1),
      duration: durationRef.current,
      strengths: [
        ...new Set([...prev.strengths, ...feedbackData.strengths.slice(0, 1)]),
      ],
      weaknesses: [
        ...new Set([
          ...prev.weaknesses,
          ...feedbackData.improvements.slice(0, 1),
        ]),
      ],
    }))
  }
  ...
  const handleSimulateResponse = () => {
    ...
    setTranscript([...transcript, { speaker: 'You', text: randomResponse }])
        ...
        {showSummary ? (
          ...
          <div className="bg-gray-900/60 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-purple-500/20 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium ${getScoreColor(sessionStats.averageScore)}`}
                    >
              ...
              <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700">
                <h3 className="text-lg font-medium mb-2 text-yellow-300">
                  Areas to Improve
                </h3>
                <ul className="space-y-2">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm font-medium text-gray-300">
                      {Math.round(sentimentScore.confidence)}%
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm font-medium text-gray-300">
                      {Math.round(sentimentScore.clarity)}%
                    </span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-sm font-medium text-gray-300">
                      {Math.round(sentimentScore.engagement)}%
                    </span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2.5">
                    <div
            ...
            <div className="bg-gray-900/60 backdrop-blur-lg p-6 rounded-xl shadow-xl border border-purple-500/20">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t border-gray-700">
                  <h3 className="text-md font-medium mb-3 text-purple-300">
                    Session Controls
                  </h3>
                      ...
                      <div className="bg-gray-800/70 rounded-lg border border-gray-700 p-4 max-h-60 overflow-y-auto">
                        <div className="space-y-4">
                          {transcript.map((entry, index) => (
                            <div
                              key={index}
                              className={`flex ${entry.speaker === 'AI Interviewer' ? 'justify-start' : 'justify-end'}`}
                            >
                              <div
                    ...
                    <div className="mt-6 animate-fade-in">
                      ...
                      <div className="bg-purple-900/30 p-4 rounded-lg border border-purple-600">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <span
                            className={`font-bold text-lg ${getScoreColor(feedback.score)}`}
                          >
                            {feedback.score}%
                          </span>
                        </div>
                          ...
                          <div>
                            ...
                            <ul className="text-sm space-y-1">
                              {feedback.strengths.map((strength, index) => (
                                <li key={index} className="flex items-start">
                                  <svg
                                    className="w-4 h-4 text-green-400 mr-1 mt-0.5"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg"
