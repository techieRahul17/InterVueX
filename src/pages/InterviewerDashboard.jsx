                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
                    <div className="bg-gray-900 rounded-xl border border-purple-500/30 p-6 max-w-md w-full">
                        ...
                        <p className="text-gray-300 mb-6 text-center">
                            You are about to join this interview as an <span className="font-bold text-purple-300">interviewer</span>.
                        ...
                        <div className="bg-purple-900/30 p-4 rounded-lg border border-purple-600 mb-6">
                            <p className="text-sm text-gray-200">
                                <span className="font-bold text-purple-300">Features available:</span>
                            </p>
